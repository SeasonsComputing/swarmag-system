...
export const toJob = (dict: Dictionary): Job => {
  ...
  if (!dict['customer_id']) {
    throw new Error('Job dictionary missing required field: customer_id')
  }
...
export const toJobAssessment = (dict: Dictionary): JobAssessment => {
  ...
  if (!dict['job_id']) {
    throw new Error('JobAssessment dictionary missing required field: job_id')
  }
  if (!dict['assessor_id']) {
    throw new Error('JobAssessment dictionary missing required field: assessor_id')
  }
  if (!dict['locations']) {
    throw new Error('JobAssessment dictionary missing required field: locations')
  }
  if (!dict['created_at']) {
    throw new Error('JobAssessment dictionary missing required field: created_at')
  }
  if (!dict['updated_at']) {
    throw new Error('JobAssessment dictionary missing required field: updated_at')
  }
...
export const toJobWorkflow = (dict: Dictionary): JobWorkflow => {
  ...
  if (dict['sequence'] === undefined || dict['sequence'] === null) {
    throw new Error('JobWorkflow dictionary missing required field: sequence')
  }
  if (!dict['basis_workflow_id']) {
    throw new Error('JobWorkflow dictionary missing required field: basis_workflow_id')
  }
  if (!dict['created_at']) {
    throw new Error('JobWorkflow dictionary missing required field: created_at')
  }
  if (!dict['updated_at']) {
    throw new Error('JobWorkflow dictionary missing required field: updated_at')
  }
...
export const toJobPlanAssignment = (dict: Dictionary): JobPlanAssignment => {
  if (!dict['plan_id']) {
    throw new Error('JobPlanAssignment dictionary missing required field: plan_id')
  }
  if (!dict['user_id']) {
    throw new Error('JobPlanAssignment dictionary missing required field: user_id')
  }
  if (!dict['role']) {
    throw new Error('JobPlanAssignment dictionary missing required field: role')
  }
...
export const toJobPlanChemical = (dict: Dictionary): JobPlanChemical => {
  if (!dict['plan_id']) {
    throw new Error('JobPlanChemical dictionary missing required field: plan_id')
  }
  if (!dict['chemical_id']) {
    throw new Error('JobPlanChemical dictionary missing required field: chemical_id')
  }
  if (dict['amount'] === undefined || dict['amount'] === null) {
    throw new Error('JobPlanChemical dictionary missing required field: amount')
  }
...
export const toJobPlanAsset = (dict: Dictionary): JobPlanAsset => {
  if (!dict['plan_id']) {
    throw new Error('JobPlanAsset dictionary missing required field: plan_id')
  }
  if (!dict['asset_id']) {
    throw new Error('JobPlanAsset dictionary missing required field: asset_id')
  }
...
export const toJobPlan = (dict: Dictionary): JobPlan => {
  ...
  if (!dict['scheduled_start']) {
    throw new Error('JobPlan dictionary missing required field: scheduled_start')
  }
  if (!dict['created_at']) {
    throw new Error('JobPlan dictionary missing required field: created_at')
  }
  if (!dict['updated_at']) {
    throw new Error('JobPlan dictionary missing required field: updated_at')
  }
...
export const toJobWork = (dict: Dictionary): JobWork => {
  ...
  if (!dict['started_at']) {
    throw new Error('JobWork dictionary missing required field: started_at')
  }
  if (!dict['started_by_id']) {
    throw new Error('JobWork dictionary missing required field: started_by_id')
  }
  if (!dict['created_at']) {
    throw new Error('JobWork dictionary missing required field: created_at')
  }
  if (!dict['updated_at']) {
    throw new Error('JobWork dictionary missing required field: updated_at')
  }
...
export const toJobWorkLogEntry = (dict: Dictionary): JobWorkLogEntry => {
  ...
  if (!dict['job_id']) {
    throw new Error('JobWorkLogEntry dictionary missing required field: job_id')
  }
  if (!dict['user_id']) {
    throw new Error('JobWorkLogEntry dictionary missing required field: user_id')
  }
  if (!dict['created_at']) {
    throw new Error('JobWorkLogEntry dictionary missing required field: created_at')
  }
