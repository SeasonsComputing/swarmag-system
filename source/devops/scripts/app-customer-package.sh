...
APP_ROOT="${ROOT}/source/front/app-customer"
ENV_FILE="${ROOT}/source/front/config/app-customer-${TARGET}.env"
ENV_EXAMPLE_FILE="${ROOT}/source/front/config/app-customer-${TARGET}.env.example"
