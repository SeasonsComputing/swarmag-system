...
**Related:** `effort/completed/2026-07-12-edge-functions-remediation-design.md` (D12 — the CORS fix that unblocked User Manager entirely, closed same week); `effort/project/project-feature-parking-lot.md` (eject semantics, deferred here)
