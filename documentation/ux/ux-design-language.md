...
| `ux-design-archetypes.md`    | Composition: archetypes, their vocabulary, and the supporting library           |
...
- `--sa-icon` is a glyph binding custom property owned by `icons.css`, not a provider
...
| `--sa-gradient-`     | Gradient color styles                 | `--sa-gradient-brand`, `--sa-gradient-brand-90`, `--sa-gradient-card`, `--sa-gradient-hero`, `--sa-gradient-stripe`                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
