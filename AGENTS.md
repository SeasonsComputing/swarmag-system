...
| Application features | 1. `documentation/architecture/architecture-front.md`<br>2. `documentation/architecture/architecture-devops.md`<br>3. `documentation/ux/ux-components-guide-lite.md`<br>4. `documentation/project/project-user-stories.md` |
